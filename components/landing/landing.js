              ...
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                ...
                <div className="flex flex-row mt-12">
                  <Image
                    src={lwizara}
                    alt=""
                    className="h-[80px] w-[90px] me-4"
                  />
                  <Image src={fsbm} alt="" className="h-[80px] w-[90px] me-4" />
                  <Image
                    src={snrst}
                    alt=""
                    className="h-[80px] w-[90px] me-4"
                  />
                  <Image src={bgd} alt="" className="h-[80px] w-[100px] me-4" />
                  <Image src={fsbm} alt="" className="h-[80px] w-[90px] me-4" />
                  <Image src={univ} alt="" className="h-[80px] w-[90px]" />
                </div>
              </div>
              <Image
                src={Rachik}
